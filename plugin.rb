...
after_initialize do
  Email::Sender.class_eval do
    ...
    # @@account_sid = "AC099ca9905db01eec9655bb42fa8cb4ec"
    # @@auth_token = "766d1142b93c45e102d71833e18ac0da"
    # @@client = Twilio::REST::Client.new @@account_sid, @@auth_token

    # @@from = "+17787621346"

    def account_sid
      return SiteSetting.twilio_notifications_account_sid
    end

    def auth_token
      return SiteSetting.twilio_notifications_auth_token
    end
    ...
    def user_mobile(user)
      return "+" + user.custom_fields["mobile"]
    end
